...
class Scanner(object):
  ...
  def t_FLOAT(self,t):
      r"\d+(\.\d*)|\.\d+"
      t.type='FLOAT'
      t.value = AST.Float(t.value, t.lineno, self.find_tok_column(t))
      return t

  def t_INTEGER(self,t):
      r"\d+"
      t.type = 'INTEGER'
      t.value = AST.Integer(t.value, t.lineno, self.find_tok_column(t))
      return t
  
  def t_STRING(self,t):
      r'\"([^\\\n]|(\\.))*?\"'
      t.type='STRING'
      t.value= AST.String(t.value,t.lineno, self.find_tok_column(t))
      return t
  ...
  def t_ID(self,t):
      ...
      t.value = AST.ID(t.value,t.lineno,self.find_tok_column(t))
      return t
